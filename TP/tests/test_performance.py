...
def test_triangulation_1k_points():
    ...
    triangulate(points) # Teste la performance avec 1000 points

@pytest.mark.performance
def test_triangulation_10k_points():
    points = [(i, i*0.1) for i in range(10000)]
    triangulate(points) # Teste la performance avec 10000 points

@pytest.mark.performance
def test_triangulation_50k_points():
    points = [(i, i*0.1) for i in range(50000)]
    triangulate(points) # Teste la performance avec 50000 points
